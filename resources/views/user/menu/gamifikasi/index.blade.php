...
@section('isi')
    ...
    @include('user.menu.gamifikasi.hapus')
                            ...
                            if (data.length === 0) {
                                ...
                                $.each(data, function(index, item) {
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <!-- Button Edit -->
                                            <a href="user/ujian/tampil${item.kdujian}" class="btn btn-warning">
                                                <i class="fas fa-pen"></i> Edit
                                            </a>
                                            ...
                                            <div class="modal fade" id="Hapus${item.kdujian}" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
                                                <div class="modal-dialog">
                                                    <div class="modal-content">
                                                        ...
                                                        <form action="user/ujian-hapus/${item.kdujian}" method="POST">
