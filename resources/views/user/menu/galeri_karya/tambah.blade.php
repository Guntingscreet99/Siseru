                        ...
                        <form action="{{ route('user.galeri.tambah') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="row g-4">
                                ...
                                <div class="row g-4 mt-2">
                                    <div class="col-md-6">
                                        <label class="form-label fw-bold">Nama Karya <span
                                                class="text-danger">*</span></label>
                                        <input type="text" name="namaKarya"
                                            class="form-control form-control-lg @error('namaKarya') is-invalid @enderror"
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input type="file" name="fileKarya"
                                            class="form-control form-control-lg @error('fileKarya') is-invalid @enderror"
                                    ...
                                    <div class="col-12">
                                        <label class="form-label fw-bold">Deskripsi Karya <span
                                                class="text-danger">*</span></label>
                                        <textarea name="deskripsi" rows="5" class="form-control form-control-lg @error('deskripsi') is-invalid @enderror"
                                ...
                                {{-- <div class="col-md-6">
                                    ...
                                    <select name="id_kelas"
                                        class="form-select form-select-lg @error('id_kelas') is-invalid @enderror" required>
                                        <option value="">-- Pilih Kelas --</option>
                                        @foreach ($kelas as $k)
                                            <option value="{{ $k->id }}"
                                ...
                                <div class="col-md-6">
                                    <label class="form-label fw-bold">Semester <span class="text-danger">*</span></label>
                                    <select name="id_semester"
                                        class="form-select form-select-lg @error('id_semester') is-invalid @enderror"
                                        required>
                                        <option value="">-- Pilih Semester --</option>
