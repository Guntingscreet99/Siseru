...
@section('judul', 'Admin | Edit Data Ranking')
@section('isi')
                    ...
                    <div class="card-body">
                        ...
                        <div class="mb-3" style="display: flex; justify-content: space-between">
                            <div class="form-group">
                                <a href="{{ url('admin/master/dataperingkat') }}" class="btn btn-primary">
                        ...
                        <form action="{{ url('admin/peringkat-edit/' . $peringkat->kdperingkat) }}" method="POST"
