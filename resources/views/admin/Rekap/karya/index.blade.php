                    ...
                    <div class="card-body">
                        <div class="judul1 mb-3">
                            <h5 class="text-center fw-bold">
                                Rekap Karya per User
                            </h5>
                            <span>
                                Tanggal :
                                <strong>
                                    {{ $rekap->isNotEmpty() ? optional($rekap->first())->created_at?->format('d-m-Y') ?? '-' : '-' }}
                                </strong>
                            </span>
                        </div>
                        <hr>
                        <div class="row mb-3 align-items-center">
                            <!-- FILTER KELAS -->
                            <div class="col-md-3">
                                <form method="GET" action="{{ route('admin.rekap.karya') }}"
                        ...
                        <h5 class="text-center fw-bold">3 User dengan Nilai Karya Tertinggi</h5>
                        <div class="table-responsive">
                            <table class="table table-bordered">
